...
- **AIScreen.js** _[[Removed for safety (AI hallucination risk)]]_: An AI chat powered by DeepSeek (via OpenRouter). The model receives the user’s last 5 diary entries as context and returns polished, readable advice. Responses always emphasize consulting a real doctor.
